...
const Home = () => {
  ...
  const skills = [
    ...
    { name: 'Tailwind CSS', level: 95, color: '#06B6D4', icon: LayoutGrid },
    { name: 'Node.js', level: 80, color: '#339933', icon: Database },
    { name: 'Next.js', level: 75, color: '#000000', icon: Rocket },
    { name: 'Git', level: 85, color: '#F05032', icon: GitBranch },
    { name: 'Figma', level: 70, color: '#F24E1E', icon: FigmaIcon },
    { name: 'AWS', level: 65, color: '#FF9900', icon: Cloud }
  ];
