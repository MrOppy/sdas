...
const SkillCard = ({ name, level, color, icon: IconComponent, index }: SkillCardProps) => {
  return (
    ...
    >
      ...
      {/* Card content */}
      <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-xl overflow-hidden">
        ...
        <span className="text-sm mt-2 inline-block font-medium">{level}%</span>
