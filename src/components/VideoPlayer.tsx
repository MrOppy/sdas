    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <div 
            ref={progressRef}
            className="relative flex-grow h-2 bg-white/10 rounded-full cursor-pointer group/progress"
          ...
          >
            ...
            >
              {/* Thumb */}
              <div className="absolute right-0 top-1/2 -translate-y-1/2 w-4 h-4 bg-purple-500 rounded-full scale-0 group-hover/progress:scale-100 transition-transform duration-150" />
            </div>
          </div>
